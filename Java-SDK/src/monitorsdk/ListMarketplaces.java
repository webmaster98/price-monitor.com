...
{
    private static Set<String> listMarkets = new LinkedHashSet<>(Arrays.asList(
            "123preis.com",
            "4insiders.de",
            "4phones.de",
            "abebooks.de",
    ...
    public static Set<String> getListMarkets()
    {
        return listMarkets;
    }

    static boolean isValidMarketplace(String marketplace)
    {
    ...
    private static boolean isEmptyMarketPlace(String marketplace)
    {
